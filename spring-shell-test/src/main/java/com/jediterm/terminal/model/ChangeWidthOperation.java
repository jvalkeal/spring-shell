...
class ChangeWidthOperation {
	...
	ChangeWidthOperation( TerminalTextBuffer textBuffer,
	...
	void addPointToTrack( Point point) {
		myTrackingPoints.put(new TrackingPoint(point, false), null);
	}

 void addPointToTrack( Point point, boolean isForceVisible) {
	...
	private static TerminalLine.TextEntry subEntry( TerminalLine.TextEntry entry, int startInd, int count) {
