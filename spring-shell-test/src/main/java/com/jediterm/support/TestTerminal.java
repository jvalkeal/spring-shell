...
public class TestTerminal extends JediTerminal {
	...
	public TestTerminal(TerminalTextBuffer terminalTextBuffer, StyleState initialStyleState) {
	...
	private TestTerminal(TestTerminalDisplay bufferDisplay, TerminalTextBuffer terminalTextBuffer,
