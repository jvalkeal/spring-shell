...
public class TerminalTypeAheadManager {
	...
	public TerminalTypeAheadManager(TypeAheadTerminalModel terminalModel) {
	...
	public void onKeyEvent(TypeAheadEvent keyEvent) {
	...
	private TypeAheadPrediction createPrediction(TypeAheadTerminalModel.LineWithCursorX initialLineWithCursorX,
																												TypeAheadEvent keyEvent) {
