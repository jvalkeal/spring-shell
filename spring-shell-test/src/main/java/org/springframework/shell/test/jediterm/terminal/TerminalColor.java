...
public class TerminalColor {
	...
	public TerminalColor(Supplier<Color> colorSupplier) {
		this(-1, null, colorSupplier);
	}

	private TerminalColor(int colorIndex, Color color, Supplier<Color> colorSupplier) {
		if (colorIndex != -1) {
			assert color == null;
	...
	private String padStart(String str, int totalLength, char ch) {
