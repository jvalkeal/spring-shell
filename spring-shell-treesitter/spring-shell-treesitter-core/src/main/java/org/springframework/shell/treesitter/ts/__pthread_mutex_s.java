...
public class __pthread_mutex_s {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        TreeSitter.C_INT.withName("__lock"),
        TreeSitter.C_INT.withName("__count"),
        TreeSitter.C_INT.withName("__owner"),
        TreeSitter.C_INT.withName("__nusers"),
        TreeSitter.C_INT.withName("__kind"),
        TreeSitter.C_SHORT.withName("__spins"),
        TreeSitter.C_SHORT.withName("__elision"),
