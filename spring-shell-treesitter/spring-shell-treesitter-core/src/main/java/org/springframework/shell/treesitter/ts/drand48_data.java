...
public class drand48_data {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        MemoryLayout.sequenceLayout(3, TreeSitter.C_SHORT).withName("__x"),
        MemoryLayout.sequenceLayout(3, TreeSitter.C_SHORT).withName("__old_x"),
        TreeSitter.C_SHORT.withName("__c"),
        TreeSitter.C_SHORT.withName("__init"),
        TreeSitter.C_LONG_LONG.withName("__a")
