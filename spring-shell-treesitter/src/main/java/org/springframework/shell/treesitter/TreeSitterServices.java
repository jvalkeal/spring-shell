...
public final class TreeSitterServices<T> implements Iterable<T> {
	 ...
	 */
	public static final String FACTORIES_RESOURCE_LOCATION = "META-INF/spring/treesitter.factories";
	...
	private TreeSitterServices(List<T> loaded, Map<String, T> beans) {
	...
	public static class Loader {
		 ...
		 */
		public <T> TreeSitterServices<T> load(Class<T> type) {
			return new TreeSitterServices<>(this.springFactoriesLoader.load(type), loadBeans(type));
		}
