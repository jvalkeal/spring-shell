...
public class random_data {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        TreeSitter.C_POINTER.withName("fptr"),
        TreeSitter.C_POINTER.withName("rptr"),
        TreeSitter.C_POINTER.withName("state"),
        TreeSitter.C_INT.withName("rand_type"),
        TreeSitter.C_INT.withName("rand_deg"),
        TreeSitter.C_INT.withName("rand_sep"),
        MemoryLayout.paddingLayout(4),
        TreeSitter.C_POINTER.withName("end_ptr")
