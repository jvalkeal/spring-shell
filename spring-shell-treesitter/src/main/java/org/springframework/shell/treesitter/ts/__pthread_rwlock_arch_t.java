...
public class __pthread_rwlock_arch_t {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        TreeSitter.C_INT.withName("__readers"),
        TreeSitter.C_INT.withName("__writers"),
        TreeSitter.C_INT.withName("__wrphase_futex"),
        TreeSitter.C_INT.withName("__writers_futex"),
        TreeSitter.C_INT.withName("__pad3"),
        TreeSitter.C_INT.withName("__pad4"),
        TreeSitter.C_INT.withName("__cur_writer"),
        TreeSitter.C_INT.withName("__shared"),
        TreeSitter.C_CHAR.withName("__rwelision"),
        MemoryLayout.sequenceLayout(7, TreeSitter.C_CHAR).withName("__pad1"),
        TreeSitter.C_LONG.withName("__pad2"),
        TreeSitter.C_INT.withName("__flags"),
