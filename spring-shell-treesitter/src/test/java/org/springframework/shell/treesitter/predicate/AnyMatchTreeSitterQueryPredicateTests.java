...
class AnyMatchTreeSitterQueryPredicateTests {
	...
	void test1() {
		...
		Pattern pattern1 = Pattern.compile("fakecontent");
		Pattern pattern2 = Pattern.compile("fakenotcontent");
		AnyMatchTreeSitterQueryPredicate predicate = new AnyMatchTreeSitterQueryPredicate("test", List.of(pattern1, pattern2));
