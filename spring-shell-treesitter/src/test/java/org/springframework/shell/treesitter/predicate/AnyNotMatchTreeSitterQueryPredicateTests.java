...
class AnyNotMatchTreeSitterQueryPredicateTests {
	...
	void test1() {
		...
		Pattern pattern1 = Pattern.compile("fakecontent1");
		Pattern pattern2 = Pattern.compile("fakecontent2");
		AnyNotMatchTreeSitterQueryPredicate predicate = new AnyNotMatchTreeSitterQueryPredicate("test", List.of(pattern1, pattern2));
